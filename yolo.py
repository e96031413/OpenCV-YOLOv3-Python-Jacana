...
def runYOLODetection(args):
    ...
    labelsPath = os.path.sep.join([args["yolo"], "voc-bird.names"])
    ...
    weightsPath = os.path.sep.join([args["yolo"], "yolov3_10000.weights"])
    configPath = os.path.sep.join([args["yolo"], "yolov3-bird.cfg"])
